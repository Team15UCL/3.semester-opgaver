...
namespace Uge7Opgave2._01.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, string sortOrder, string currentFilter)
        {
            ...
            ViewData["AgeSort"] = string.IsNullOrEmpty(sortOrder) ? "age_asc" : "";
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,TeamNum,Age")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,TeamNum,Age")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
